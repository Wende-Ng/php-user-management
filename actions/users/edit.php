...
<form method="post">
    ...
    Vorname:<br>
    <input type="text" name="Vorname" value="<?= $user->getVorname(); ?>"/><br><br>
    Nachname:<br>
    <input type="text" name="Nachname" value="<?= $user->getNachname(); ?>"/><br><br>
    E-mail:<br>
    <input type="email" name="e_mail" value="<?= $user->getEMail(); ?>"/><br><br>
    <input type="submit" name="edit" value="save"/>
</form>
<p align="right"> Username: <?= $_SESSION['username']; ?> </p>
<form method="post">
...
if (isset($_POST['logout'])) {
    session_destroy();
    header("Location: /user-management/index");
}
?>
